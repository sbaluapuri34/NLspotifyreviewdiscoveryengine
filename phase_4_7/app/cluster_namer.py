...
For each of the following feedback clusters, generate a short, descriptive, professional name/title (max 4-6 words) based on its key themes and representative review snippets.
The name should be specific to the core issue (e.g., "Smart Shuffle Loop on Sonos" or "Discover Weekly Recommendation Stale").

You MUST respond with a JSON object mapping each cluster_id to its generated name:
{{
