...
class SemanticAnchorProjector:
    def __init__(self, embedder):
        ...
        # Embed all anchors
        names = list(ANCHOR_PHRASES.keys())
        phrases = list(ANCHOR_PHRASES.values())
...
class DynamicFilterEngine:
    def __init__(self, db_conn, embedder):
        self.conn = db_conn
        self.embedder = embedder
        self.projector = SemanticAnchorProjector(embedder)
        self.tfidf_extractor = ClusterTfidfExtractor()
