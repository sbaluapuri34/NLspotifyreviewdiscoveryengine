...
def main():
    ...
    for r in reviews:
        ...
        is_discovery = any(kw in txt for kw in discovery_keywords)
        if is_discovery:
    ...
    # Since this is a focused subset (~4k reviews), we use a higher threshold (0.70) to get fine-grained clusters.
